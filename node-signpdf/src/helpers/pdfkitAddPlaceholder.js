...
const pdfkitAddPlaceholder = ({
    ...
    const signature = pdf.ref({
        ...
        M: new Date(),
        ContactInfo: new String(signatureInfo.email || 'cuongdq.payment@gmail.com'), // eslint-disable-line no-new-wrappers
        Name: new String(signatureInfo.name || 'c3.mobifone.vn'), // eslint-disable-line no-new-wrappers
        Location: new String(signatureInfo.location || 'Da Nang, Vietnam'), // eslint-disable-line no-new-wrappers
    });
